-- ============================================================
-- FIX 1: Store selected shipping details at checkout
-- FIX 3: Expand notification types for order lifecycle
-- ============================================================

BEGIN;

-- ============================================================
-- 1. Add shipping detail columns to orders table
-- ============================================================
...
ALTER TABLE orders ADD COLUMN IF NOT EXISTS expected_delivery_days INTEGER;

-- ============================================================
-- 2. Recreate create_order_secure() with new shipping params
-- ============================================================
...
-- ============================================================
-- 3. Expand notifications CHECK constraint to support order lifecycle
-- ============================================================
