...
-- Recreate calculate_checkout_pricing without delivery_countries or product_domestic_shipping references.
-- delivery_countries was dropped; product_domestic_shipping does not exist in the live DB.
-- Eligibility comes from origin-country match or product_international_shipping.
-- Domestic shipping charge defaults to 0 (frontend fetches live Shiprocket/Shippo rates).
-- International shipping charge comes from product_international_shipping.
